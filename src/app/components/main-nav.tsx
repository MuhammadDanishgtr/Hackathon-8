    ...
    <nav className="bg-white shadow-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className="flex gap-6">
              <Link href="/" className="text-[#272343] hover:text-[#00BAB5]">
                Home
              </Link>
              <Link href="./components/products/contact" className="text-[#272343] hover:text-[#00BAB5]">
                Shop
              </Link>
              <Link href="./components/products" className="text-[#272343] hover:text-[#00BAB5]">
                Products
              </Link>
              <Link href="/" className="text-[#272343] hover:text-[#00BAB5]">
                Pages
              </Link>
              <Link href="./components/about" className="text-[#272343] hover:text-[#00BAB5]">
                About
              </Link>
            </div>
            <div className="text-[#272343]">0800 555 5555</div>
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link href="/" className="block px-3 py-2 text-[#272343] hover:text-[#00BAB5]">
              Home
            </Link>
            <Link href="./components/products/contact" className="block px-3 py-2 text-[#272343] hover:text-[#00BAB5]">
              Shop
            </Link>
            <Link href="./components/products" className="block px-3 py-2 text-[#272343] hover:text-[#00BAB5]">
              Products
            </Link>
            <Link href="/" className="block px-3 py-2 text-[#272343] hover:text-[#00BAB5]">
              Pages
            </Link>
            <Link href="./components/about" className="block px-3 py-2 text-[#272343] hover:text-[#00BAB5]">
              About
            </Link>
          </div>
          <div className="px-5 py-4 border-t border-gray-200">
