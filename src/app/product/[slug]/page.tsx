...
export default async function ProductPage( {params}:ProductPageProps){
  ...
  <select className="select select-bordered">
    ...
    <option>Standard</option>
        ...
        <span className="ml-60">Quantity </span>
        <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
          <FaMinus className="w-fit h-fit" /> Less
          </button>
          <div className="ml-2 mr-2 scroll-m-20 text-base font-semibold tracking-tight">
            1
          </div>
          <button className="flex ml-0 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">
          <FaPlus className="w-fit h-fit" /> Add
          </button>
        </div> */}
